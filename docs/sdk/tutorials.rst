...
3. :doc:`Categorize a Document manually <tutorials/set-category-manually/index>`

Get to know how to assign and change Category of Documents and its Pages manually.

4. :doc:`Categorize a Document using Categorization AI <tutorials/document_categorization/index>`
...
5. :doc:`Create your own Categorization AI <tutorials/create-custom-categorization-ai/index>`
...
6. :doc:`Build a Context-Aware File Splitting Model <tutorials/build-context-aware-file-splitting-model/index>`
...
7. :doc:`Train and use a Context-Aware File Splitting Model <tutorials/context-aware-file-splitting-model/index>`

Familiarize yourself with a simple fallback logic for splitting stream of Pages into separate sub-Documents.

8. :doc:`Create your own File Splitting AI <tutorials/create-custom-splitting-ai/index>`
...
9. :doc:`Evaluate the performance of a File Splitting AI <tutorials/file-splitting-evaluation/index>`

Get to know how to work with FileSplittingEvaluation class, assess the performance of Splitting AIs and interpret the
results.

10. :doc:`Tokenization <tutorials/tokenizers/index>`
...
11. :doc:`Information Extraction <tutorials/information_extraction/index>`
...
12. :doc:`Upload your AI model to use on Konfuzio app or an on-prem installation <tutorials/upload-your-ai/index>`
...
13. :doc:`Named Entity Recognition <tutorials/ner-ontonotes-fast/index>`
...
14. :doc:`Annual Reports Analysis <tutorials/annual-reports/index>`
...
15. :doc:`Barcode Scanner <tutorials/barcode-scanner/index>`
...
16. :doc:`PDF Form Generator <tutorials/pdf-form-generator/index>`
...
18. :doc:`Data Validation <tutorials/data_validation/index>`
...
19. :doc:`Outlier Annotations <tutorials/outlier-annotations/index>`
