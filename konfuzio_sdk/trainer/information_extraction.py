...
class RFExtractionAI(Trainer, GroupAnnotationSets):
    ...
    def evaluate_full(self, strict: bool = True, use_training_docs: bool = False) -> ExtractionEvaluation:
        """
        ...
        self.full_evaluation = ExtractionEvaluation(eval_list, strict=strict)
    ...
    def evaluate_clf(self, use_training_docs: bool = False) -> ExtractionEvaluation:
        ...
        clf_evaluation = ExtractionEvaluation(eval_list)

        return clf_evaluation

    def evaluate_template_clf(self, use_training_docs: bool = False) -> ExtractionEvaluation:
        ...
        template_clf_evaluation = ExtractionEvaluation(eval_list)
