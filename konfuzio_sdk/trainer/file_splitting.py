...
class SplittingAI:
    ...
    def evaluate_full(
        self, use_training_docs: bool = False, zero_division_handling: bool = False
        ...
        self.full_evaluation = FileSplittingEvaluation(original_docs, pred_docs, zero_division_handling)
