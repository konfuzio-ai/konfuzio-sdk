...
class ExtractionService(PicklableModelService):
    ...
    @handle_exceptions
    async def extract(self, ctx: bentoml.Context, **request: Any) -> ExtractResponse20240117:
        ...
        document = ExtractResponse20240117.prepare_request(
            request=request,
            project=project,
        ...
        annotations_result = ExtractRequest20240117.process_response(result)
